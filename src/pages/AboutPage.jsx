...
function AboutUs() {
  return (
    <HeaderFooterLayout title ="About Us">
...
-        <ImageCarousel />
        ...
        <section className="our-story">
          ...
          <p>
            ...
            has evolved into a <strong> premier destination</strong> for
            travelers seeking a unique blend of <strong> relaxation</strong>,
          ...
          <p>
            ...
            experience the tranquility and adventure that embody the spirit of
          ...
          <p>
            ...
            unwind or to explore, our story is woven into the very fabric of
            these majestic peaks, inviting you to become part of it.
          </p>
        </section>
        ...
        <section className="experience">
          ...
          <p>
            Whether you are seeking adventure in the great outdoors or a
            peaceful retreat, Serenity Mountain offers an array of activities
            and amenities tailored to your desires. From hiking trails and spa
            treatments to exquisite dining, every moment at Serenity Mountain is
            crafted to create lasting memories.
          </p>
        </section>
      </div>
    </HeaderFooterLayout>
